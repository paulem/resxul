...
namespace Resxul.Framework.Shortcuts
{
    /// <summary>
    ...
    internal class ShellLink : IDisposable
    {
        ...
        private IPersistFile PersistFile
        {
            get
            {
                var pf = shellLink as IPersistFile;
                if (pf == null)
        ...
        internal string TargetPath
        {
            get
            {
                ...
                VerifySucceeded(shellLink.GetPath(sb, sb.Capacity, ref data, SLGP.SLGP_UNCPRIORITY));
        ...
        internal SW WindowStyle
        {
            ...
            {
                SW showCmd;
                VerifySucceeded(shellLink.GetShowCmd(out showCmd));
        ...
        internal string IconPath
        {
            get
            {
                var sb = new StringBuilder(MAX_PATH - 1);
                int index;
                VerifySucceeded(shellLink.GetIconLocation(sb, sb.Capacity, out index));
